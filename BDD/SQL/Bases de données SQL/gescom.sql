...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 08 fév. 2021 à 14:12
...
INSERT INTO `employees` (`emp_id`, `emp_superior_id`, `emp_pos_id`, `emp_lastname`, `emp_firstname`, `emp_address`, `emp_zipcode`, `emp_city`, `emp_mail`, `emp_phone`, `emp_salary`, `emp_enter_date`, `emp_gender`, `emp_children`, `emp_shop_id`, `emp_dep_id`) VALUES
...
INSERT INTO `shops` (`shop_id`, `shop_name`, `shop_address`, `shop_zipcode`, `shop_city`) VALUES
